...
export default function MessagesPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold">Messages</h1>
      <p className="mt-1 text-sm text-foreground/50">Chat with partners about your bookings</p>
        ...
        <div className="w-full shrink-0 space-y-2 lg:w-72">
          {conversations.length === 0 ? (
            <div className="rounded-2xl border border-foreground/10 bg-card p-6 text-center text-sm text-foreground/50">
              ...
              <p className="mt-1">Messages will appear here when you contact a partner.</p>
            </div>
          ) : (
